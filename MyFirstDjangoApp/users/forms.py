...
class UserForm(UserCreationForm):
    ...
    password1 = forms.CharField(widget=forms.PasswordInput(attrs={'placeholder':'*Your password..','c;ass':'password'}))
    password2 = forms.CharField(widget=forms.PasswordInput(attrs={'placeholder':'*Your confirm password..','class':'password'}))
